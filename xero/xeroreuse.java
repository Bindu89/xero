...
public static void initialize_driver() {
	...
	public static void launchurl( String url,String TestName) {
	...
	public static WebElement FindElement(By location,String objname) {
		...
		try {
			...
			System.out.println("FAIL: " +objname+" page not found on page");
			//logger.log(LogStatus.FAIL,""+ objname+ " page not found on page");
		}
